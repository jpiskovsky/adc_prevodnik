...
/** @addtogroup STM8S_StdPeriph_Driver
  ...
  */
/**
  * @addtogroup TIM5_Private_Functions
  * @{
  */
...
/**
  ...
  * @retval None
  */
void TIM5_TI1_Config(uint8_t TIM5_ICPolarity,
...
/**
  ...
  * @retval None
  */
void TIM5_TI2_Config(uint8_t TIM5_ICPolarity,
                       uint8_t TIM5_ICSelection,
                       uint8_t TIM5_ICFilter)
{
...
/**
  ...
  * @retval None
  */
void TIM5_TI3_Config(uint8_t TIM5_ICPolarity, uint8_t TIM5_ICSelection,
                       uint8_t TIM5_ICFilter)
{
