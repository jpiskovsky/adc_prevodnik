                     ...
                     uint8_t TIM5_ICFilter)
{
  ...
  {
    /* TI1 Configuration */
    TIM5_TI1_Config((uint8_t)TIM5_ICPolarity, (uint8_t)TIM5_ICSelection,
               (uint8_t)TIM5_ICFilter);
    ...
    /* TI2 Configuration */
    TIM5_TI2_Config((uint8_t)icpolarity, (uint8_t)icselection, (uint8_t)TIM5_ICFilter);
  ...
  {
    /* TI2 Configuration */
    TIM5_TI2_Config((uint8_t)TIM5_ICPolarity, (uint8_t)TIM5_ICSelection,
               (uint8_t)TIM5_ICFilter);
    ...
    /* TI1 Configuration */
    TIM5_TI1_Config((uint8_t)icpolarity, (uint8_t)icselection, (uint8_t)TIM5_ICFilter);
